...
<body>
    ...
    <table>
        ...
        // Query to fetch specializations and count of doctors for each specialization
        $sql = "SELECT Specializations, COUNT(*) AS DoctorCount FROM doctor GROUP BY Specializations";
